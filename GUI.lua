...
-- ============================
-- CUSTOM NAME INPUT
-- Letakkan SETELAH webhookTextBox dan SEBELUM discordIDContainer
-- ============================

-- Input untuk Custom Name
local currentCustomName = ""

local customNameContainer = new("Frame", {
    Parent = catWebhook,
    Size = UDim2.new(1, 0, 0, 80),
    BackgroundColor3 = colors.bg2,
    BackgroundTransparency = 0.8,
...
local customNameLabel = new("TextLabel", {
    Parent = customNameContainer,
    Size = UDim2.new(1, -20, 0, 22),
    Position = UDim2.new(0, 10, 0, 8),
    BackgroundTransparency = 1,
...
local customNameTextBox = new("TextBox", {
    Parent = customNameContainer,
    Size = UDim2.new(1, -20, 0, 38),
    Position = UDim2.new(0, 10, 0, 35),
    BackgroundColor3 = colors.bg3,
    ...
    BorderSizePixel = 0,
    Text = "",
    PlaceholderText = "Masukkan nama custom (kosongkan untuk nama asli)",
    Font = Enum.Font.Gotham,
    TextSize = 9,
    TextColor3 = colors.text,
    TextTransparency = 0.2,
...
customNameTextBox.FocusLost:Connect(function(enterPressed)
    local value = customNameTextBox.Text
    currentCustomName = value
    if webhookLoadSuccess and WebhookModule then
        WebhookModule:SetCustomName(value)
        if value ~= "" then
            Notify.Send("Webhook 🔔", "Custom name tersimpan: " .. value, 2)
        else
            Notify.Send("Webhook 🔔", "Custom name dihapus, menggunakan display name asli", 2)
        end
    end
end)
